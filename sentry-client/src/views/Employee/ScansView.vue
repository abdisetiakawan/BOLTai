            ...
            <CardContent class="space-y-6">
              ...
              <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                  <Button variant="outline" size="sm" @click="clearInput">
                    <X class="w-3 h-3 mr-1" />
                    Clear
                  </Button>
                  <Button variant="outline" size="sm" @click="focusInput">
                    <Focus class="w-3 h-3 mr-1" />
                    Focus
                  </Button>
                </div>
              </div>
                  ...
                  <table class="min-w-full text-sm">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="py-2 px-4">
                          <Badge
                            :variant="scan.isOut ? 'outline' : 'secondary'"
                            class="text-xs"
                          >
